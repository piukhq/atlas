...
class UserChannelIdentifier(models.Model):
    ...
    scheme_account_id = models.IntegerField(null=True)
    created_scheme_account = models.DateTimeField(null=True, help_text="Scheme account created date")
    ...
    originating_journey = models.IntegerField(
        null=True, help_text="Journey type ID (Join = 0, Link = 1, Add = 2, Update = 3, Register = 4, Unknown = 5)"
    )
    scheme_id = models.IntegerField(null=True)
