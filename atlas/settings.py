...
# RABBITMQ DETAILS
RABBITMQ_USER = env_var('TXM_RABBITMQ_USER')
RABBITMQ_PASS = env_var('TXM_RABBITMQ_PASS')
RABBITMQ_HOST = env_var('TXM_RABBITMQ_HOST')
RABBITMQ_PORT = env_var('TXM_RABBITMQ_PORT')
