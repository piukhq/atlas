    ...
    def post(request):
        ...
        if start < end:
            ...
            try:    # Get transactions in a list of dicts so we can write them to csv
                ...
                return Response(
                    data='Date must reflect YYYY-MM-DD format: {}'.format(e),
        ...
        try:
            ...
            logger.info(
                'Method: TransactionBlobView.write_to_csv: No transactions between these dates: {}--{}'.format(start,
                                                                                                               end))
            return Response(
        ...
        try:
            create_blob_from_csv(transactions_csv,
