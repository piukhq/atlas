...
class TestTransactionBlobView(APITestCase):
    ...
    def test_get_transaction_is_called_if_dates_are_correct_format(
        self, mock_get_transactions, mock_create_blob, mock_write_to_csv
    ):
    ...
    def setUp(self):
        self.export_transaction_data = {
            ...
            "audit_data": {
                "request": {
                    "body": (
                        '{"message_uid": "e0dc4d6b-1184-4b70-909b-b2472efae96a", "transactions": '
